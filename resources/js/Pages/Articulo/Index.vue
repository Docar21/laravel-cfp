...
const verArticulo=(id)=>{
    page.props.articulos.data.forEach(articulo => {
        if (articulo.id==id) {
                                        ...
                                        <div class="overflow-x-auto p-3">
                                            <!--div class="bg-gray-50 overflow-hidden sm:py-12"></div-->
                                                <!--DataTable id="example"  class="example display w-full border border-gray-400"
                                                    :data="$page.props.articulos.data" :columns="columnas"
                                                ...
                                                <thead
                                                    ...
                                                    <tr
                                                        ...
                                                        <th scope="col" class="py-3 px-6">Numero Articulo</th>
                                                ...
                                                <tbody>
                                                    <tr class="border-b dark:bg-gray-800 dark:border-gray-700"
                                                        ...
                                                        <th scope="col" class="">
                                                            <button class="boton ver" @click="verArticulo(articulo.id)"><svg class="h-6 w-6 text-blue-800 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" /></svg></button>
                                                            <button class="boton editar" dataId="'+id+'"><svg class="h-6 w-6 text-blue-800 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg></button>
                                                            <button class="boton eliminar" dataId="'+id+'"><svg class="h-6 w-6 text-blue-800 mr-3"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polyline points="3 6 5 6 21 6" />  <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />  <line x1="10" y1="11" x2="10" y2="17" />  <line x1="14" y1="11" x2="14" y2="17" /></svg></button>
                                                        </th>
                                                    </tr>
                                                </tbody>
                                            </table>
...
<div class="p-6">
    ...
    <form @submit.prevent="importar_excel" class="px-8 pt-6 pb-8">
        <div>
            ...
            <input type="file" name="format" id="format" @input="formImport.avatar = $event.target.files[0]">
